...
namespace DynamicFogAndMist {
				...
				public class DynamicFog : MonoBehaviour {
								...
								public 	bool	useSinglePassStereoRenderingMatrix = false;


								Material fogMatAdv, fogMatFogSky, fogMatOnlyFog, fogMatVol, fogMatSimple, fogMatBasic;
								[SerializeField]
								Material
												fogMat;
								...
								void OnRenderImage (RenderTexture source, RenderTexture destination) {
												...
												if (useSinglePassStereoRenderingMatrix && UnityEngine.VR.VRSettings.enabled) {
