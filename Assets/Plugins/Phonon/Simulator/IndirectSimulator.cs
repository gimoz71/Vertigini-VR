    ...
    public class IndirectSimulator
    {
            ...
            EnvironmentalRenderer environmentalRenderer)
        {
                ...
                && environmentalRenderer.GetEnvironmentalRenderer() != IntPtr.Zero)
            {
                ...
                if (PhononCore.iplCreateConvolutionEffect(environmentalRenderer.GetEnvironmentalRenderer(), effectName, 
                    simulationMode, inputFormat, ambisonicsFormat, ref propagationAmbisonicsEffect) != Error.None)
                {
